...
<head>
    ...
    <title>Form Laporan Petugas - Gacor Edition</title>
    <style>
        /* Reset */
        * {
...
<body>
    <div class="container">
        ...
        <form action="{{ route('laporan.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <input type="text" name="nama_petugas" value="{{ $penugasan->petugas->Nama }}" readonly>
            <input type="hidden" name="id_petugas" value="{{ $penugasan->id_petugas }}">
            ...
            <textarea name="deskripsi_tugas" id="deskripsi_tugas" placeholder="Jelaskan deskripsi tugas..." required>{{ old('Deskripsi_Tugas') }}</textarea>

            <label for="upload_foto">Bukti Foto</label>
            <input type="file" name="upload_foto" id="upload_foto" accept="image/*">

            <div class="button-container">
                <button type="submit" class="btn-submit">Simpan</button>
                <a href="{{ url('/petugaslapangan') }}" class="btn-back" role="button">Kembali</a>
            </div>
        </form>
