...
use App\Http\Controllers\C_Penanggungjawab;
...
/*
|--------------------------------------------------------------------------
| Petugas Lapangan & Laporan
|--------------------------------------------------------------------------
*/
Route::get('/petugaslapangan', [C_PetugasLapangan::class, 'index'])->name('petugaslapangan.index');
Route::get('/laporan-petugas', [C_PetugasLapangan::class, 'index'])->name('laporan.index');
